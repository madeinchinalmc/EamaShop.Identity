...
namespace EamaShop.Client.Identity.Models
{
    ...
    {
        /// <summary>
        /// Initializes a new instance of the UserInfoDTO class.
        /// </summary>
        public UserInfoDTO() { }
        ...
        /// Initializes a new instance of the UserInfoDTO class.
        /// </summary>
        public UserInfoDTO(long? userId = default(long?), string accountName = default(string), string phone = default(string), string email = default(string), string nickName = default(string), string headImageUri = default(string), int? sexy = default(int?), DateTime? lastLoginTime = default(DateTime?), int? role = default(int?), string country = default(string), string city = default(string), string province = default(string))
        {
            UserId = userId;
